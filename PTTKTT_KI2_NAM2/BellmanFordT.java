...
public class BellmanFordT {
    ...
    public BellmanFordT(EdgeWeightedDigraph G, int s) {
        ...
        for (int v = 0; v < G.V(); v++) {
            ...
            // print shortest paths
                ...
                if (hasPathTo(v)) {
                    StdOut.printf("%d to %d (%5.2f)  ", v, s, distTo(s));
    ...
    private void reset(EdgeWeightedDigraph G, int s) {
    ...
    /**
     * Unit tests the {@code BellmanFordT} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        BellmanFordT sp = new BellmanFordT(G, s);
